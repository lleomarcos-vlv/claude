...
/**
 * Backup automático do banco SQLite. Exporta o banco atual para um arquivo
 * .db independente (SQLite padrão). Mantém apenas os N backups mais recentes
...
async function criarBackup() {
  await db.inicializar(); // no-op se já inicializado (ex.: servidor em execução)
  const cx = db.get();
