 ...
 * para http://127.0.0.1:PORT. Isso mantém o módulo nativo better-sqlite3 no
 * ABI do Node (sem necessidade de recompilar para o Electron) e torna a
 * instalação "dois cliques" muito mais confiável.
 *
 * Caso o Node não esteja acessível como processo separado, há um fallback que
 * inicia o servidor dentro do próprio Electron.
 */
